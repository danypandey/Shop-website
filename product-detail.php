...
<?php require_once 'config.php' ?>
  ...
  <!-- product category -->
    ...
    $sql = "SELECT * FROM `products` WHERE `product_id`='{$pd}' ";
                    ...
                    <div class="row">
                        ...
                        <div class="aa-product-view-slider">                                
                            ...
                            <div class="simpleLens-container">
                                <div class="simpleLens-big-image-container"><a data-lens-image="<?php echo $row["image"] ?>" class="simpleLens-lens-image"><img src="<?php echo $row["image"] ?>" class="simpleLens-big-image"></a></div>
                            </div>
                        ...
                        <div class="aa-product-view-content">
                            ...
                            <a class="aa-add-to-cart-btn" href="cart.php?productId=<?php echo $row["product_id"] ?>">Add To Cart</a>
