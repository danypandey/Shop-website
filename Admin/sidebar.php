<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
            ...
            $settingsmenu = array('general.php');
            ?>
            ...
            <ul id="main-nav">  <!-- Accordion Menu -->
                ...
                <li> 
                    <a href="#" class="nav-top-item <?php if (in_array($filename, $productsmenu) ) : ?>current<?php endif  ?>"> <!-- Add the class "current" to current menu item -->
                    Products
                    </a>
                    <ul>
                ...
                <li>
                    <a href="#" class="nav-top-item <?php if (in_array($filename, $settingsmenu) ) : ?>current<?php endif  ?>">
                        Settings
                    </a>
                    <ul>
